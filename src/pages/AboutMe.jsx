      ...
      <div className='aboutMeInfo'>
          <div className='about-Flex'>
            ...
            <div className='photoAlbum'>
              ...
              <img src={lucaPhoto} alt="A photo of Luca" className='mePhoto' />
              <img src={lolaPhoto} alt="A photo of Lola" className='mePhoto' />
              <img src={myFam} alt="A photo of Maria and Luca" className='mePhoto' />
            </div>
      </div>
    </div>
  );
